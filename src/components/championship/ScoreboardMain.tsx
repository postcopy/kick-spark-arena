...
export function ScoreboardMain({
  ...
  const renderRoundIndicators = (wins: number, maxRounds: number) => {
    ...
    for (let i = 0; i < neededToWin; i++) {
      indicators.push(<span key={i} className="text-lg">
          {i < wins ? '●' : '○'}
        </span>);
    }
    return indicators;
  };
  return <div className="h-full flex items-stretch p-4 gap-2 relative">
      {/* MATCH END Overlay */}
      ...
      <div className="flex-1 flex flex-col bg-[hsl(var(--sulsport-blue))] rounded-lg overflow-hidden">
        ...
        <div className="h-16 flex items-center justify-center border-b border-white/10">
          <div className="text-center">
            ...
            {state.config.athleteBlue?.country && <div className="text-sm text-white/70">
      ...
      <div className="flex-1 flex flex-col bg-[hsl(var(--sulsport-red))] rounded-lg overflow-hidden">
        ...
        <div className="h-16 flex items-center justify-center border-b border-white/10">
          <div className="text-center">
            ...
            {state.config.athleteRed?.country && <div className="text-sm text-white/70">
