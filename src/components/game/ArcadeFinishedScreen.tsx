...
export function ArcadeFinishedScreen({ result, onPlayAgain, onBackToMenu }: ArcadeFinishedScreenProps) {
  ...
  return (
    <div className="flex flex-col h-full w-full overflow-hidden bg-[#0b1120] relative">
      <div className="flex-1 min-h-0 overflow-y-auto flex flex-col items-center justify-center px-6 md:px-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 w-full max-w-7xl mx-auto items-stretch relative z-10">

        {/* COLUNA ESQUERDA — Emoção (3/5) */}
        <div className="lg:col-span-3 flex flex-col justify-center items-center lg:items-start text-center lg:text-left relative">
          {/* Header badge */}
        ...
        {/* COLUNA DIREITA — Dados (2/5) */}
        <div className="lg:col-span-2 flex flex-col justify-center">
          <div className="bg-[#0b1120]/80 p-4 md:p-6 rounded-xl border border-white/10 backdrop-blur-sm h-full min-h-[300px] flex flex-col justify-center">
      ...
      {/* === BOTÕES DE AÇÃO (fora do grid, abaixo) === */}
