...
interface SetupTutorialDialogProps {
  ...
  accentColor?: string; // tailwind color class e.g. 'bg-[#F59E0B]' or 'bg-green-500'
}
...
export function SetupTutorialDialog({ open, onOpenChange, accentColor = 'bg-[#F59E0B]' }: SetupTutorialDialogProps) {
  const textColor = accentColor === 'bg-green-500' ? 'text-green-500' : 'text-[#F59E0B]';
