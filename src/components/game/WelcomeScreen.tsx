        ...
        <div className="w-full max-w-md flex flex-col items-center text-center space-y-6">
          ...
          <div className="w-full space-y-3 pt-4">
            <Link to="/login" className="block w-full">
              <Button
                size="lg"
                className="w-full h-14 md:h-16 text-lg font-bold rounded-xl bg-gradient-to-r from-[#E11D48] to-[#9F1239] text-white hover:from-[#C81840] hover:to-[#8F1035] shadow-lg shadow-[#E11D48]/30"
              >
