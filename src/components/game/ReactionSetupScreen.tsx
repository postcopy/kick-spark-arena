...
export function ReactionSetupScreen({
  ...
  return (
    <div className="flex flex-col h-full w-full bg-[#0b1120] p-4 md:p-6 overflow-hidden relative">
      ...
      {/* Main */}
      <main className="flex-1 min-h-0 flex flex-col max-w-6xl w-full mx-auto md:overflow-hidden overflow-y-auto gap-3 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 flex-shrink-0">
          ...
          {/* Difficulty — flat horizontal bars */}
        ...
        <div className="bg-black/20 p-4 md:p-6 rounded-xl border border-white/10 flex-1 min-h-0">
